'''
Linked List construction, lets do all these as part of this exercise 
  1. InsertBeggining
  2. InsertEnd
  3. InsertAtK
  4. DeleteBeginning
...
class LinkedList:
    ...
    def delete_at_beginning(self):
        print('deleted node beginning : ',self.head.data)        
    ...
    def delete_at_end(self):
        ...
        while curr.next is not None:
            prev = curr
            curr = curr.next
        print('deleted node is end : ',curr.data)
        prev.next = None 
    ...
    def delete_at_position(self, k):
        if k > 1:
            ...
            while pos < k-1:
                temp = temp.next
                pos = pos+1
            print ("Node deleted is ", temp.data)
            ...
            print ("Enter a valid node location")
            return -1
    ...
    def print_from_end(self, node):
        if node is None:
            print
            return
        self.print_from_begining(node.next)
        print(node.data)
