...
2. a=[4,6,8,9,9,9,9,10,11,12,13]
Handle the case of duplicates as return first occurence, last occurrence and as found.

3. Using binary search find how many times sorted array is cyclically rotated
94568 is circularly rotated once

98456 is circularly rotated twice

4. a = [9,8,4,5,6]
Find ele in circularly sorted array
'''
